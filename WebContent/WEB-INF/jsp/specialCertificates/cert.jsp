...
<body style="min-height:100%;padding:0px;margin:0px;">
	<script id="toolbar" type="text/html">
		<form class="layui-form" id="form1" lay-filter="queryform" onkeydown="if(event.keyCode==13){return false}">
			...
			<div class="layui-form-item">
				<label class="layui-form-label" style="">认证时间</label>
				<div class="layui-input-inline">
					<input type="text" name="certificationTimeStr" readonly="readonly" placeholder="请输入认证时间" autocomplete="off" class="layui-input test-item">
				</div>

				<label class="layui-form-label" style="">复审时间</label>
				<div class="layui-input-inline">
					<input type="text" name="reviewTimeStr" id="reviewTimeStr" readonly="readonly" placeholder="请输入认证时间" autocomplete="off" class="layui-input test-item">
				</div>

				<label class="layui-form-label">有效期</label>
				<div class="layui-input-inline">
					<input type="text" name="termOfValidity" style="width:150px;" placeholder="有效期(月)" autocomplete="off" class="layui-input" />
				</div>
			</div>
	...
	<div id="dlg" style="padding-top: 5px;display:none;">
		<form class="layui-form" lay-filter="frm1">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="certificateNumber" name="certificateNumber" lay-verify="required|title" autocomplete="off" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
				<div class="layui-inline">
					...
					<div class="layui-input-inline">
						<input type="text" id="certificationTimeStr" name="certificationTimeStr" readonly="readonly" lay-verify="required" autocomplete="off" class="layui-input test-item">
					</div>
					<label class="layui-form-label">有效期</label>
					<div class="layui-input-inline">
						<input type="text" id="termOfValidity" name="termOfValidity" lay-verify="required|number" autocomplete="off" class="layui-input">
					</div>
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					...
					<div class="layui-upload-list" id="uploader-otherList">
<%--						<p id="otherImgEdit"></p>--%>
					</div>
				</div>
			</div>
	...
	<div id="dlgDetail" style="padding-top: 5px;display:none;">
		<form class="layui-form" lay-filter="frm1Detail">
			...
			<div class="layui-form-item">
				...
				<label class="layui-form-label">证件编号</label>
				<div class="layui-input-inline">
					<input type="text" name="certificateNumber" disabled class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
				<div class="layui-inline">
					<label class="layui-form-label">认证时间</label>
					<div class="layui-input-inline">
						<input type="text" name="certificationTime" disabled class="layui-input">
					</div>
					<label class="layui-form-label">有效期</label>
					<div class="layui-input-inline">
						<input type="text" name="termOfValidity" disabled class="layui-input">
					</div>
				</div>
			</div>
			<div class="layui-form-item">
	...
	<div id="dlgEdit" style="padding-top: 5px;display:none;">
		<form class="layui-form" lay-filter="frm1Edit">
			...
			<div class="layui-form-item">
				<div class="layui-inline">
					...
					<label class="layui-form-label">办理机构</label>
					<div class="layui-input-inline">
						<input type="text" name="handlingAgencyStr" disabled class="layui-input">
					</div>
				</div>
			</div>
			...
			<div class="layui-form-item">
				<label class="layui-form-label">证件名称</label>
				<div class="layui-input-inline">
					<input type="text" name="certificateName" lay-verify="required|title" autocomplete="off" class="layui-input">
				</div>
				<label class="layui-form-label">证件编号</label>
				<div class="layui-input-inline">
					<input type="text" disabled name="certificateNumber" lay-verify="required|title" autocomplete="off" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
				<div class="layui-inline">
					<label class="layui-form-label">认证时间</label>
					<div class="layui-input-inline">
						<input type="text" id="certificationTime1" name="certificationTimeStr" readonly="readonly" lay-verify="required" autocomplete="off" class="layui-input test-item">
					</div>
					<label class="layui-form-label">有效期</label>
					<div class="layui-input-inline">
						<input type="text" name="termOfValidity" lay-verify="required|number" autocomplete="off" class="layui-input">
					</div>
				</div>
			</div>
			...
			<div class="layui-form-item">
				<label class="layui-form-label">证书图片</label>
				<div class="layui-input-block">
					<button type="button" class="layui-btn layui-btn-xs" id="otherEdit">
						<i class="layui-icon">&#xe67c;</i>上传照片
					</button>
					<div class="layui-upload-list" id="uploader-otherList-edit">
						<p id="otherImgEdit">
						</p>
					</div>
			...
			<div class="layui-form-item">
				<div class="layui-input-block">
					<button class="layui-btn layui-btn-sm" lay-submit lay-filter="submitEdit">提交</button>
					<button class="layui-btn layui-btn-sm layui-btn-primary btn-cancel">取消</button>
				</div>
			</div>
	...
	<script src="../js/specialCertificates/cert.js?t=<%=System.currentTimeMillis()%>"></script>
