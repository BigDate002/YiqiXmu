...
<script id="toolbar" type="text/html">
	<form class="layui-form" id="form1" lay-filter="queryform" onkeydown="if(event.keyCode==13){return false}">
		...
		<shiro:hasPermission name="staff:create">
			<a class="layui-btn layui-btn-xs" lay-event="edit">证件复审</a>
		</shiro:hasPermission>
...
<div id="dlgDetail" style="padding-top: 5px;display:none;">
	<form class="layui-form" lay-filter="frm1Detail">
		...
		<div class="layui-form-item">
			...
			<label class="layui-form-label">状态</label>
			<div class="layui-input-inline">
				<input type="text" id="status" disabled class="layui-input">
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label label-height">身份证正/反面</label>
	...
	<form class="layui-form" lay-filter="frm1Edit">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				...
				<div class="layui-upload-list">
					<p id="educationCertificateImgEdit"></p>
				</div>
			</div>
		</div>
		<div class="layui-form-item">
...
<script src="../js/specialCertificates/review.js?t=<%=System.currentTimeMillis()%>"></script>
